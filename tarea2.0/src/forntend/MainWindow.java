...
public class MainWindow extends JFrame {
    ...
    private final JLabel infoLabel = new JLabel("Cargue un archivo para comenzar");
    ...
    public MainWindow() {
        ...
        testManager.onItemsLoaded.subscribe(items -> {
            currentIndex = 0;
            infoLabel.setText("Ítems: " + items.size() + " | Tiempo estimado: " + testManager.getTotalEstimatedTime() + " segundos");
            updateItem(items);
        });
    ...
    private void updateItem(List<Item> items) {
        ...
        itemPanel.loadItem(item, saved, false);
    ...
    private void updateReview(List<Item> items) {
        ...
        itemPanel.loadItem(item, selected, true);
